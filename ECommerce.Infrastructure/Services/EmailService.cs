...
namespace ECommerce.Infrastructure.Services
{
    public class EmailService : IEmailService
    {
        ...
        public async Task SendResetPasswordEmailAsync(string mailTo, string subject, string body)
        {
            var email = new MimeMessage
            {
                Sender = MailboxAddress.Parse(_configuration.Email),
            ...
            builder.HtmlBody = $@"
                    <div style=""background-color: #f9f9f9; font-family: 'Segoe UI', Tahoma, Geneva, Verdana, sans-serif; max-width: 600px; margin: 0 auto; padding: 20px; border-radius: 12px; box-shadow: 0 10px 30px rgba(0, 0, 0, 0.1);"">
                    <div style=""background-color: #ff6f61; color: #ffffff; padding: 15px; text-align: center; border-top-left-radius: 12px; border-top-right-radius: 12px; font-size: 22px; font-weight: bold;"">
                        <span style=""letter-spacing: 1px;"">ECommerce</span>
                    </div>
                    <div style=""color: #333333; padding: 30px; font-size: 16px; line-height: 1.6;"">
                        <p style=""margin-bottom: 10px;"">Dear User,</p>
                        <p style=""margin-bottom: 20px;"">We received a request to reset your password on our ECommerce platform.</p>
                        <p style=""text-align: center;"">
                            <a href=""{body}"" style=""background-color: #ff6f61; color: #fff; padding: 12px 25px; text-decoration: none; border-radius: 8px; font-size: 16px; font-weight: bold; box-shadow: 0 5px 15px rgba(0, 0, 0, 0.2);"">Reset Password</a>
                        </p>
                        <p style=""margin-top: 20px;"">If you didn't request a password reset, please ignore this email. The link will expire in 24 hours.</p>
                        <p style=""margin-top: 20px;"">Best Regards,</p>
                        <p>The ECommerce Team</p>
                        <div style=""text-align: center; margin-top: 30px; font-size: 12px; color: #999999;"">
